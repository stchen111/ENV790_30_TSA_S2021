...
nhydro <- ncol(raw_inflow_data)-2  #minus 2 to remove col of date info (month and year)
...
my_date <- paste(raw_inflow_data[,1],raw_inflow_data[,2],sep="-")  #combine month and year to date in column my_date (January-1999)
my_date <- my(my_date)  #function my from package lubridate (my -> month year)
head(my_date)
