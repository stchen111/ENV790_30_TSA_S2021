...
```{r}
#Using R decompose function - strip observation of trend, seasonal, and random component
iHP=1
...
cat(mean_inflow,sd_inflow) #Concatenate function
...
#chisq.out.test(objects,variance)
chi_test <- chisq.out.test(inflow_random$inflow,var(inflow_random$inflow))
print(chi_test) #look at the p-value to find the decision (on the highest value)
